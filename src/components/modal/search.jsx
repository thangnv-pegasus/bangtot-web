...
const Search = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 bg-[rgba(0,0,0,0.5)] z-50 flex items-center justify-center animate-enlarge">
      <button className="absolute top-0 right-0 text-white text-4xl px-4 py-2" onClick={() => dispatch(CLOSE_SEARCH())}>
        <FontAwesomeIcon icon={faXmark} />
      </button>
      <form action="" method="post" className="flex w-3/5 relative">
        <input
          type="text"
          name="searchValue"
          id=""
